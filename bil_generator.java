    ...
    {  
        public static void main(String args[])   
            {  
                ...
                System.out.println("\t\t\t\t\t "+"  "+"The Grocery Mart"); 
                System.out.println("GSTIN: 03AWBP435656K592"+"\t\t\t\t\t\t\tContact: (+91) 873629344564");  
                ...
                System.out.println("Date: "+formatter.format(date)+"  "+days[calendar.get(Calendar.DAY_OF_WEEK) - 1]+"\t\t\t\t\t\t (+91) 893564299113");  
